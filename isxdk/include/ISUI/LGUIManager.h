...
public:
	...
	LGUI_API void Reset();
	LGUI_API bool LoadInterfaceXML(char *Filename, bool Reload=false, LGUISkin *pSkin=0);
	LGUI_API bool LoadInterfaceXML(char *Filename, char *Element, char *NewName, bool Reload=false, LGUISkin *pSkin=0);
	LGUI_API bool LoadInterfaceXML(LGUIElement *pParent, char *Filename, bool Reload=false, LGUISkin *pSkin=0);
	LGUI_API bool LoadInterfaceXML(LGUIElement *pParent, char *Filename, char *Element, char *NewName, bool Reload=false, LGUISkin *pSkin=0);
	LGUI_API bool UnloadInterfaceXML(char *Filename);
	...
	LGUI_API bool ShowElement(char *Name, bool Show);
	LGUI_API bool ToggleElement(char *Name);

	LGUI_API void Render();

	LGUI_API class LGUIElementFactory *FindFactory(char *Type);
	LGUI_API class LGUIElement *FindElement(char *Name);

	unsigned int LoadTexture(char *Filename, unsigned int ColorKey);
...
//protected:
	LGUI_API LGUIElement *LoadElement(class LGUIElement *pParent, char *Type, char *Name, class XMLNode *pXML, char *Template=0);
	LGUI_API LGUIElement *LoadElement(class LGUIElement *pParent, char *Type, char *Name);
};
