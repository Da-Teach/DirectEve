...
{
public:
	LGUI_API static bool GetToggle(class XMLNode *pXML, char *Name, bool Default=0);

	LGUI_API static unsigned int GetIntValue(class XMLNode *pXML, char *Name, unsigned int Default=0);
	LGUI_API static float GetFloatValue(class XMLNode *pXML, char *Name, float Default=0.0f);
	LGUI_API static unsigned int GetHexValue(class XMLNode *pXML, char *Name, unsigned int Default=0);
	LGUI_API static unsigned int GetFactorValue(class XMLNode *pXML, char *Name, float &FactorResult, unsigned int Default=0);
	LGUI_API static unsigned int GetElementPositionValue(class XMLNode *pXML, char *Name, ElementPosition &EPResult, unsigned int Default=0);
	LGUI_API static bool GetElementPositionValueEx(class XMLNode *pXML, char *Name, ElementPosition &EPResult, unsigned int &ulResult);
	LGUI_API static char *GetStringValue(class XMLNode *pXML, char *Name, char *Default="");

	LGUI_API static class XMLNode *GetChild(class XMLNode *pXML, char *Name);
	LGUI_API static char *GetText(class XMLNode *pXML);
	...
	LGUI_API static unsigned int GetIntAttribute(class XMLNode *pXML, char *Name, unsigned int Default=0);
	LGUI_API static float GetFloatAttribute(class XMLNode *pXML, char *Name, float Default=0.0f);
	LGUI_API static unsigned int GetHexAttribute(class XMLNode *pXML, char *Name, unsigned int Default=0);
	LGUI_API static unsigned int GetFactorAttribute(class XMLNode *pXML, char *Name, float &FactorResult, unsigned int Default=0);
	LGUI_API static unsigned int GetElementPositionAttribute(class XMLNode *pXML, char *Name, ElementPosition &EPResult, unsigned int Default=0);
	LGUI_API static char *GetStringAttribute(class XMLNode *pXML, char *Name, char *Default="");


	static inline bool GetTemplateToggle(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, bool Default=0)
	{
		Default=GetToggle(pTemplate,Name,Default);
		return GetToggle(pXML,Name,Default);
	}
	static inline unsigned int GetTemplateIntValue(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, unsigned int Default=0)
	{
		Default=GetIntValue(pTemplate,Name,Default);
		return GetIntValue(pXML,Name,Default);
	}
	static inline float GetTemplateFloatValue(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, float Default=0)
	{
		Default=GetFloatValue(pTemplate,Name,Default);
		return GetFloatValue(pXML,Name,Default);
	}
	static inline unsigned int GetTemplateHexValue(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, unsigned int Default=0)
	{
		Default=GetHexValue(pTemplate,Name,Default);
		return GetHexValue(pXML,Name,Default);
	}
	static inline unsigned int GetTemplateFactorValue(class XMLNode *pXML, char *Name, float &FactorResult, class XMLNode *pTemplate)
	{
	...
	static inline unsigned int GetTemplateElementPositionValue(class XMLNode *pXML, char *Name, ElementPosition &EPResult, class XMLNode *pTemplate)
	{
		unsigned int Ret=0;
	...
	static inline char *GetTemplateStringValue(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, char *Default="")
	{
		Default=GetStringValue(pTemplate,Name,Default);
		return GetStringValue(pXML,Name,Default);
	}

	static inline class XMLNode *GetTemplateChild(class XMLNode *pXML, char *Name, class XMLNode *pTemplate)
	{
	...
	static inline unsigned int GetTemplateIntAttribute(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, unsigned int Default=0)
	{
		Default=GetIntAttribute(pTemplate,Name,Default);
		return GetIntAttribute(pXML,Name,Default);
	}
	static inline float GetTemplateFloatAttribute(class XMLNode *pXML, char *Name, class XMLNode *pTemplate, float Default=0)
	{
		Default=GetFloatAttribute(pTemplate,Name,Default);
		return GetFloatAttribute(pXML,Name,Default);
	}
	static inline unsigned int GetTemplateHexAttribute(class XMLNode *pXML, char *Name, class XMLNode *pTemplate,unsigned int Default=0)
	{
		Default=GetHexAttribute(pTemplate,Name,Default);
		return GetHexAttribute(pXML,Name,Default);
	}
	static inline unsigned int GetTemplateFactorAttribute(class XMLNode *pXML, char *Name, float &FactorResult, class XMLNode *pTemplate)
	{
		float TempFactorResult;
	...
	static inline char *GetTemplateStringAttribute(class XMLNode *pXML, char *Name, class XMLNode *pTemplate,char *Default="")
	{
...
{
public:
	LGUI_API LGUIElement(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
	...
	LGUI_API virtual LGUITexture *TextureFromXML(class XMLNode *pXML, char *ValueName, class XMLNode *pTemplate=0);
	LGUI_API virtual LGUIFont *FontFromXML(class XMLNode *pXML, char *ValueName, class XMLNode *pTemplate=0);
	LGUI_API virtual LGUIFixedFont *FixedFontFromXML(class XMLNode *pXML, char *ValueName, class XMLNode *pTemplate=0);
	LGUI_API virtual LGUIEmbeddedScript *EmbeddedScriptFromXML(class XMLNode *pXML, char *ValueName, class XMLNode *pTemplate=0, char *Parameters="");
	...
	LGUI_API virtual LGUIElement *FindChild(char *Name);
	LGUI_API LGUIElement *FindUsableChild(char *Name, char *Type);
...
//	LGUI_API bool DrawPoints(_ColoredPoint *Points, unsigned int nPoints);
	...
	LGUI_API unsigned int DrawText(LGUIFont *pFont,const char *Text,int X, int Y);
	LGUI_API unsigned int DrawTextClipped(LGUIFont *pFont,const char *Text,int X, int Y);
	LGUI_API unsigned int DrawTextCenter(LGUIFont *pFont,const char *Text,int X, int Y);
	LGUI_API unsigned int DrawTextRight(LGUIFont *pFont,const char *Text,int X, int Y);

	LGUI_API unsigned int DrawTextClipped(LGUIFont *pFont,const char *Text,int X, int Y, int RightX);
	LGUI_API unsigned int DrawTextCenter(LGUIFont *pFont,const char *Text,int X, int Y, int RightX);
	LGUI_API unsigned int DrawTextRight(LGUIFont *pFont,const char *Text,int X, int Y, int RightX);

	LGUI_API unsigned int DrawColoredText(LGUIFont *pFont,const char *buffer, int X, int Y);
	LGUI_API unsigned int DrawColoredTextClipped(LGUIFont *pFont,const char *buffer, int X, int Y, int RightX);

	static LGUI_API void StripColor(const char *In, char *Out);
	static LGUI_API unsigned int ColorStrlen(const char *Text);
...
{
public:
	LGUIElementFactory(char *p_Type, unsigned int LGUIVersion)
	{
...
//						delete i->first; // fuck it, avoid crashing
	...
	LGUI_API void Register(char *p_Type, unsigned int LGUIVersion);
	LGUI_API void Unregister();

	LGUI_API virtual LGUIElement *CreateUIElement(LGUIElement *pParent, char *Name, class XMLNode *pXML, char *Template=0)=0;
	LGUI_API virtual LGUIElement *CreateUIElement(LGUIElement *pParent, char *Name)=0;
...
public:
	...
	LGUIFactory(char *p_Type):LGUIElementFactory(p_Type,LGUI_VERSION)
	{
	}
	...
	virtual LGUIElement *CreateUIElement(LGUIElement *pParent, char *Name, class XMLNode *pXML, char *Template=0)
	{
	...
	virtual LGUIElement *CreateUIElement(LGUIElement *pParent, char *Name)
	{
		T *pElement = new T(Type,pParent,Name);
		Elements[pElement]=1;
		return pElement;
...
public:
	...
	DelayedLGUIFactory(char *p_Type)
	{
		Type=strdup(p_Type);
		pFactory=false;
	}
