...
{
public:
	LGUI_API LGUIWindow(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
	...
	LGUI_API LGUIElement *FindChild(char *Name);
...
{
public:
	LGUIWindowClient(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
...
{
public:
	LGUIWindowFactory(char *p_Type):LGUIElementFactory(p_Type,LGUI_VERSION)
	{
	}
