...
{
public:
	LGUI_API LGUIMapBlip(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
...
{
public:
	LGUI_API LGUIMapBlipView(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
...
{
public:
	LGUI_API LGUIMap(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
...
{
public:
	LGUI_API LGUIMapView(char *p_Factory, LGUIElement *p_pParent, char *p_Name);
