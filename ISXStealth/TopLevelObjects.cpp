...
bool __cdecl TLO_Stealth(int argc, char *argv[], LSTYPEVAR &Dest)
{
	// argc and argv are used if the object access uses an index, such as Stealth[1] or 
	// Stealth[my coat,1,seventeen].  argc is the number of parameters (or dimensions) separated 
